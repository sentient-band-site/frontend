  ...
  return (
    <>
      <div className="">
          ...
          <div className="md:ml-10 md:w-1/2">
            ...
            <div className="mt-10 md:mt-0">
              ...
              <p className="lg:text-lg md:mt-16">
                ...
                we
                {"'"}ve been developing since the start. We{"'"}ve been working
                on this one since the start of Sentient but it was never in a
                state we could show to you until now.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="">
            <Image src={Tidal} sizes="500" alt="tidal" className="mb-10" />
          </div>
          <div className="md:ml-10 md:w-1/2">
        ...
        >
          ...
          <div className="md:ml-10 md:w-1/2">
            ...
            <div className="mt-10 md:mt-0">
              ...
              <p className="lg:text-lg md:mt-16">
                Our take on Daughter{"'"}s beautiful song, Be On Your Own Way
                has a more heavier tone. This song spoke to us on a level we
                couldn
                {"'"}t describe and felt compelled to make a version that was
                true to us.
              </p>
            </div>
          </div>
